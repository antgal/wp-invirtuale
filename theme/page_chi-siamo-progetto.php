<?php
/**
 * The template for the Chi Siamo Progetto page
 *
 * Template Name: Chi Siamo Progetto Page
 *
 * @package INVIRTUALE
 */
...
<section class="section section-text-light section-center section-header mt-0 mb-0 border-top-0 p-0" style="background: radial-gradient(circle, #78b4d2 0%, #165b77 100%);">
	<div class="section-header-text">
		<div class="container">
			<img alt="Logo" class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logo-ldp0.png" style="height:220px;">
...
<div class="container mt-5" >
	<div class="row">
		...
		<a class="btn btn-primary btn-bordered mb-5 mt-3" href="<?php invirtuale_get_base_path(); ?>chi-siamo-team">Conosci il team</a>		
		</div>
	</div>
</div>
...
<section class="section section-default section-no-border mt-0 mb-0 pb-0">
	<div class="container pt-3 text-center">
		...
		<img alt="Locations" class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/map-ldp0.png"></img>
