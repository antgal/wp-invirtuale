	...
	<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.7" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on'}">
		<ul>
			<li data-transition="fade">
				<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/slides/slide-construction-1.jpg"  
					alt=""
			...
			<li data-transition="fade">
				<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/slides/slide-construction-2.jpg"  
					alt=""
					data-bgposition="center 100%" 
					data-bgfit="cover" 
					data-bgrepeat="no-repeat" 
...
<div class="container">
	<div class="row mt-4 mt-lg-5 mb-4 py-4">
		...
		<div class="col-lg-2 text-center d-none d-lg-block">
			<img src="<?php invirtuale_get_theme_base_path(); ?>img/dotted-line-angle.png" class="img-fluid" />
		</div>
		<div class="col-lg-6">
	...
	<div class="container">
		...
		<div class="row mt-4">
			<div class="col-lg-6">
				<div class="feature-box feature-box-style-2 custom-feature-box mb-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
					<div class="feature-box-icon">
						<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/icons/ground-construction.png" alt="" class="img-fluid" />
					</div>
			...
			<div class="col-lg-6">
				<div class="feature-box feature-box-style-2 custom-feature-box mb-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
					<div class="feature-box-icon">
						<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/icons/construction.png" alt="" class="img-fluid" />
					</div>
					<div class="feature-box-info ml-3">
		...
		<div class="row mt-3 mb-4">
			<div class="col-lg-6">
				<div class="feature-box feature-box-style-2 custom-feature-box mb-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
					<div class="feature-box-icon">
						<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/icons/painting.png" alt="" class="img-fluid" />
					</div>
					<div class="feature-box-info ml-3">
			...
			<div class="col-lg-6">
				<div class="feature-box feature-box-style-2 custom-feature-box mb-4 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
					<div class="feature-box-icon">
						<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/icons/plumbing.png" alt="" class="img-fluid" />
					</div>
					<div class="feature-box-info ml-3">
					...
					<ul class="diamonds">
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-1.jpg" class="diamond">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-1.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-2.jpg" class="diamond">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-2.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-3.jpg" class="diamond">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-3.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-4.jpg" class="diamond diamond-sm">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-4.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-5.jpg" class="diamond">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-5.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-6.jpg" class="diamond diamond-sm">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-6.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
						<li>
							<a href="img/demos/construction/gallery/construction-gallery-7.jpg" class="diamond diamond-sm">
								<div class="content">
									<img src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/gallery/construction-gallery-7.jpg" class="img-fluid" />
								</div>
							</a>
						</li>
					</ul>
...
<section class="section section-background mb-4" style="background-image: url(<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/testimonials/testimonials-bg.jpg); background-position: 50% 100%; min-height: 540px; background-size: cover;">
	<div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<div class="owl-carousel owl-theme stage-margin rounded-nav" data-plugin-options="{'margin': 10, 'loop': false, 'nav': true, 'dots': false, 'stagePadding': 40, 'items': 6, 'autoplay': true, 'autoplayTimeout': 3000}">
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-1.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-2.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-3.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-4.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-5.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-6.png" alt="">
					</div>
					<div>
						<img class="img-fluid" src="<?php invirtuale_get_theme_base_path(); ?>img/logos/logo-4.png" alt="">
					</div>
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="recent-posts mt-4">
					<a href="demo-construction-blog-detail.html">
						<img class="img-fluid pb-3" src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/blog/blog-construction-1.jpg" alt="Blog">
					</a>
					<article class="post">
						<div class="date">
						...
						<a class="mt-3" href="demo-construction-blog-detail.html">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
					</article>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="recent-posts mt-4">
					<a href="demo-construction-blog-detail.html">
						<img class="img-fluid pb-3" src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/blog/blog-construction-2.jpg" alt="Blog">
					</a>
					<article class="post">
						<div class="date">
							<span class="day">15</span>
			...
			<div class="col-lg-4">
				<div class="recent-posts mt-4">
					<a href="demo-construction-blog-detail.html">
						<img class="img-fluid pb-3" src="<?php invirtuale_get_theme_base_path(); ?>img/demos/construction/blog/blog-construction-3.jpg" alt="Blog">
					</a>
					<article class="post">
						<div class="date">
							<span class="day">15</span>
